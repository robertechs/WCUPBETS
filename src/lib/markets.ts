...
export const WCUP_MARKETS: WcupMarketDef[] = [
  ...
  },
  {
    ...
    title: "Will $ARGENTINA hit $200K market cap by end of 21th May?",
    description: "Resolves YES if FDV ≥ $200K on DexScreener by May 21 at 11:59 PM UTC.",
    topic: "MC Target",
    roundId: "may21",
    targetMcUsd: 200_000,
    resolutionRule: "mc_gte",
  },
  {
    ...
    title: "Will $BRAZIL hit $200K market cap by end of May 21th?",
    description: "Resolves YES if FDV ≥ $200K on DexScreener by May 21 at 11:59 PM UTC.",
    topic: "MC Target",
    roundId: "may21",
    targetMcUsd: 200_000,
  ...
  },
  {
    ...
    title: "Will $ENGLAND be below $100K market cap by end of May 21th?",
    description: "Resolves YES if FDV < $100K on DexScreener by May 21 at 11:59 PM UTC.",
    topic: "MC Target",
    roundId: "may21",
    targetMcUsd: 100_000,
  ...
  },
  {
    ...
    title: "Will $PORTUGAL be below $100K market cap by end of May 22th?",
    description: "Resolves YES if FDV < $100K on DexScreener by May 22 at 11:59 PM UTC.",
    topic: "MC Target",
    roundId: "may22",
    targetMcUsd: 100_000,
    resolutionRule: "mc_lt",
